...
public abstract class ConfigurableConstants 
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(ConfigurableConstants.class);
    ...
    {
    	Assert.hasText(propertyFileName,"property file name can't be null for configurable constants");
